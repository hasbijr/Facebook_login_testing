...
WebUI.setEncryptedText(findTestObject('Object Repository/Facebook/Page_Facebook  log in or sign up/Page_Facebook  log in or sign up/input_Facebook helps you connect and share _ab63fc'), 
    'jlAttnFtTSpLzHNeCTU8vw==')

WebUI.sendKeys(findTestObject('Object Repository/Facebook/Page_Facebook  log in or sign up/Page_Facebook  log in or sign up/input_Facebook helps you connect and share _ab63fc'), 
    Keys.chord(Keys.ENTER))

WebUI.verifyElementText(findTestObject('Facebook/Page_Facebook  log in or sign up/Page_Log in to Facebook/div_The password that youve entered is incorrect. Forgotten password'), 
